...
SBB_util::end_clock()
{
	...
	timeResults[0] = real_time_diff/ticks_per_second_casted;
	timeResults[1] = user_time_diff/ticks_per_second_casted;
	timeResults[2] = system_time_diff/ticks_per_second_casted;
